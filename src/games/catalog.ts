...
export const gameCatalog: GameCatalogEntry[] = [
  ...
  { id: "frequency_recall_v2", name: "Frequency Recall", category: "sensory", ranked: true, description: "Reconstruct five tones one at a time for a score out of 50." },
  { id: "colour_recall_v2", name: "Colour Recall", category: "sensory", ranked: true, description: "Reconstruct five colours one at a time for a score out of 50." },
  ...
  { id: "typing_sprint", name: "Typing Sprint", category: "mind", ranked: true, description: "Type a deterministic word stream for fifteen seconds." },
