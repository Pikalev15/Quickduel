...
Frequency Recall uses logarithmically distributed 120–2000Hz sine tones with
short attack/release ramps. Rhythm Recall schedules brief 720Hz ticks from
relative millisecond offsets. No microphone permission, audio upload, decoded
asset, or background playback is used.
